...
module.exports = function() {
    ...
    /*
     * JadeRenderer - renders jade templates
     * 
     */
    function JadeRenderer(appName, appBase) {
        this.appName = appName;
        this.appPath = appBase;
    }
    
    /*
     * JadeRenderer.init() - configuration
     * 
     * - cfg, object has
     ...
     *      - data: template data
     */
    JadeRenderer.prototype.init = function(cfg) {
    ...
    JadeRenderer.prototype.render = function() {
        ...
        if(this.templateFile) {
            html = Jade.renderFile( this.appPath + '/' + this.templateFile, _.extend( {}, this.options || {}, this.data || {}) );
        }
